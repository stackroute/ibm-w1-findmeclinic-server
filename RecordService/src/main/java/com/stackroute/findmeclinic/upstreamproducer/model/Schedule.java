...
public class Schedule {
	...
	public Schedule(String scheduleId, String description, String workPlace, LocalDate scheduleDate,
			LocalTime startTime, LocalTime endTime, long timePerPatient, String createdBy) {
