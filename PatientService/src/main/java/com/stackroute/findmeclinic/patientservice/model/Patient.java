...
public class Patient {
	...
	public Patient(String patientEmail, String patientFirstName, String patientLastName, String patientPhoneNumber,
			...
			String patientBloodGroup, int patientDobDate, int patientDobMonth, int patientDobYear) {
		super();
	...
	public String toString() {
		return "Patient [patientEmail=" + patientEmail + ", patientFirstName=" + patientFirstName + ", patientLastName="
				...
				+ ", patientAge=" + patientAge + ", patientBloodGroup=" + patientBloodGroup + ", patientDobDate="
				+ patientDobDate + ", patientDobMonth=" + patientDobMonth + ", patientDobYear=" + patientDobYear + "]";
	}
